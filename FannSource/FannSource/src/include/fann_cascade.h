...
FANN_EXTERNAL int FANN_API fann_train_outputs(struct fann *ann, struct fann_train_data *data, float desired_error); 
FANN_EXTERNAL int FANN_API fann_initialize_candidates(struct fann *ann);
FANN_EXTERNAL int FANN_API fann_train_candidates(struct fann *ann, struct fann_train_data *data);
FANN_EXTERNAL void FANN_API fann_install_candidate(struct fann *ann);
FANN_EXTERNAL void FANN_API fann_set_shortcut_connections(struct fann *ann);                          
